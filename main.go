...
func setRouterA() {
	...
	routerA.POST(constants.FeedUserActivityIDMarkReadRoute, middleware.LTMValidationMiddleware(redisClient, false), middleware.RateLimitingMiddleware(redisClient), feed.NotificationFeedActivityMarkRead)
