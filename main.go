...
func main() {
	...
	router.GET("/channel/:channel_id/settings/member/:member_uuid", LTMValidationMiddleware(client, true), APIKeyValidationMiddleware(), channel.GetUserChannelSettings)
	router.PUT("/channel/:channel_id/settings/member/:member_uuid", LTMValidationMiddleware(client, true), APIKeyValidationMiddleware(), channel.UpdateUserChannelSettings)
