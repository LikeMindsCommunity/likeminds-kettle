...
func main() {
	...
	router.GET(constants.CommunityDMStatusRoute, middleware.LTMValidationMiddleware(redisClient, true), middleware.RateLimitingMiddleware(redisClient), community.GetCommunityDMSettings)
	router.PUT(constants.CommunityDMStatusRoute, middleware.LTMValidationMiddleware(redisClient, true), middleware.RateLimitingMiddleware(redisClient), community.EditCommunityDMSettings)
	...
	router.GET(constants.ChatroomEventLinkRoute, middleware.LTMValidationMiddleware(redisClient, true), middleware.RateLimitingMiddleware(redisClient), conversation.FetchEventLink)
	...
	router.GET(constants.FeedPostIDCommentIdCommentRoute, middleware.LTMValidationMiddleware(redisClient, true), middleware.RateLimitingMiddleware(redisClient), feed.GetComment)
	router.DELETE(constants.FeedPostIDCommentIdCommentRoute, middleware.LTMValidationMiddleware(redisClient, false), middleware.RateLimitingMiddleware(redisClient), feed.DeleteComment)
	router.PUT(constants.FeedPostIDCommentIdCommentRoute, middleware.LTMValidationMiddleware(redisClient, false), middleware.RateLimitingMiddleware(redisClient), feed.EditCommentPost)
