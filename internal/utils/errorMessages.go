...
const ErrorFetchCommunitySettingsFailed = "Error while fetching community settings, err: %v"
...
const ErrorPlatformTypeInHeader = "platform type should be present in context headers"