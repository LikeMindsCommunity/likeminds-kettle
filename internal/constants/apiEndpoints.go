...
const (
	...
	UserDashboardRoute            = "/user/dashboard"
)
...
const (
	...
	FeedUserIDSaveRoute             = "/feed/user/:uuid/save"
	FeedUserIDPostRoute             = "/feed/user/:uuid/post"
	FeedUserIDCommentRoute          = "/feed/user/:uuid/comment"
	...
	FeedUserIDMetaRoute             = "/feed/user/:uuid/meta"
	FeedUserIDPostPendingRoute      = "/feed/user/:uuid/post/pending"
